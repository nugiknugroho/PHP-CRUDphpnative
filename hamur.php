...
<nav class="navbar navbar-expand-sm bg-primary navbar-dark">
  ...
  <div class="carousel-inner">
    <div class="item active">
     <img src="teacher_7.jpg" alt="Chania" width="1000px" height="1000px"></a> 
    ...
    <div class="item">
      <img src="teacher_7.jpg" alt="guru" width="1000px" height="1000px"></a>
      <div class="carousel-caption">
        <h3 style="color: red;">Website ini memudahkan siswa untuk mencari guru private</h3>
        <p></p>
      </div>
    ...
    <div class="item">
      <img src="teacher_7.jpg" alt="New York" width="1000px" height="1000px"></a>
      <div class="carousel-caption">
        <h3 style="color: red;">Website ini memudahkan siswa untuk mencari guru private</h3>
        <p></p>
      </div>
