...
<div class="container">
	...
	<p style="font-family: veranda;">DALAM FORM INI, ANDA AKAN DIMUDAHKAN UNTUK MEMILIH SENDIRI GURU YANG AKAN ANDA PESAN MELALUI FORM PEMESANAN</p>
		<h2 style="text-align: center;">FORM PENCARIAN GURU</h2>
...
$sql = "SELECT id_teacher, namateacher, pendidikan, no_telp, alamat, hargaperjam FROM teacher WHERE teacher.id_jenjang='".$jenjang."' AND teacher.id_mapel='".$mapel."'";
$query = mysqli_query($conn, $sql);
$no=0;
while ($data = mysqli_fetch_array($query)) {
$no++;    
